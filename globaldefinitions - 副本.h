...
extern const unsigned int global_min_inliers;
...
extern  double gl_start;

#define PERF_DBG_START gl_start = GetTickCount();
#define PERF_DBG_END(x) x += GetTickCount() - gl_start;
